    ...
    public static class UserRoleData
    {
        public static List<UserRole> GetRoles()
        {
            return new List<UserRole>
            {
                new UserRole
                {
                    RoleName = UserRolesEnum.Freelancer.ToString(),
                    RoleDescription = "Freelancer user access",
                    Name = UserRolesEnum.Freelancer.ToString(),
                    NormalizedName = UserRolesEnum.Freelancer.ToString().ToUpper(),
                    ConcurrencyStamp = Guid.NewGuid().ToString(),
                },
                new UserRole
                {
                    RoleName =UserRolesEnum.Client.ToString(),
                    RoleDescription = "Client User Access",
                    Name = UserRolesEnum.Client.ToString(),
                    NormalizedName = UserRolesEnum.Client.ToString().ToUpper(),
                    ConcurrencyStamp = Guid.NewGuid().ToString(),
                },
                new UserRole
                {
                    RoleName = UserRolesEnum.Admin.ToString(),
                    RoleDescription = "Admin User Access",
                    Name = UserRolesEnum.Admin.ToString(),
                    NormalizedName = UserRolesEnum.Admin.ToString().ToUpper(),
                    ConcurrencyStamp = Guid.NewGuid().ToString(),
                }
            };
        }
    ...
    public static class SpecialtyData
    {
        public static List<Specialty> GetSpecialties()
        {
            return new List<Specialty>
            {
                ...
                {
                    CategoryId = Guid.NewGuid(),
                    Name = "Recruiting & Talent Sourcing",
                },
                new Specialty
                {
                    CategoryId = Guid.NewGuid(),
        ...
        public static List<Proficiency> GetProficiencies()
        {
            return new List<Proficiency>
            {
                new Proficiency
                {
                    ...
                    Description = "I write clearly in the language"
                },
                new Proficiency
                {
                    ProficiencyType = "Conversational",
                    Description = "I write and speak clearly in the language"
                },
                new Proficiency
                {
                    ProficiencyType = "Fluent",
                    Description = "I write and speak this language fluently"
                },
                new Proficiency
                {
                    ProficiencyType = "Native or Bilingual",
                    Description = "I write and speak this language as a native"
                }
            };
        }
    }

    public static class SubscriptionFeatureData
    {
        public static List<SubscriptionFeature> GetSubscriptionFeatures()
        {
            return new List<SubscriptionFeature>
            {
                ...
                {
                    MembershipPlanId = "",
                    Feature = "10 Connects total per month"
                },
                new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Buy Connects as you need them for $0.15 + Tax each"
                },
                new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Hourly protection to ensure you're paid for each hour worked"
                },
                new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Fixed-price payments are secured through milestones"
                },
                new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Limited reports and functionality"
                },
                ...
                {
                    MembershipPlanId = "",
                    Feature = "New: 100 Connects total per month"
                },
                 new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "New: Upwork Chat Pro, a new AI app powered by OpenAI's GPT-4"
                },
                new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "View competitor bids for any job"
                }, new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Level up with weekly office hours with an Upwork Coach"
                },
                new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Get exclusive access to the Freelancer Plus group"
                },
                 new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Skip the line for Upwork Skills Certifications"
                },
                new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Enjoy a 0% service fee when you bring new clients to Upwork"
                },
                 new SubscriptionFeature
                {
                    MembershipPlanId = "",
                    Feature = "Customize your profile"
                }
            };
        }
    }
